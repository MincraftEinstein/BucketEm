...
public class GoldenEntityBucketItem extends GoldenBucketItem {
    ...
    public void storeMobType(ItemStack stack, EntityType<?> type) {
    ...
    public MobEntity getMob(World world, ItemStack stack, int index) {
        ...
        if (nbt.contains("Mob" + index)) {
            ...
            return (MobEntity) entityType.loadEntityWithPassengers(mobData, world, (entity) -> entity);
        }
        return null;
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!world.isClient) {
            Box range = player.getBoundingBox().expand(5.0);
            ...
            if (!mobs.isEmpty()) {
                ...
                storeMobType(stack, mob.getType());
