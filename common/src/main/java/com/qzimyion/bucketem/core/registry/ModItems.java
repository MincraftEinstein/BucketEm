...
public class ModItems {
    ...
    public static final RegistrySupplier<Item> SLIME_BOTTLE = ITEMS.register("slime_bottle",
            ()-> new SlimeBottle(EntityType.SLIME, Items.GLASS_BOTTLE, SoundEvents.BOTTLE_FILL_DRAGONBREATH, new Item.Properties().stacksTo(1)));
    public static final RegistrySupplier<Item> MAGMA_CUBE_BOTTLE = ITEMS.register("magma_bottle", ()-> new EntityBottleItem(EntityType.MAGMA_CUBE, Items.GLASS_BOTTLE, SoundEvents.BOTTLE_FILL_DRAGONBREATH ,new Item.Properties().stacksTo(1)));
