...
import com.qzimyion.bucketem.common.items.SlimeLikeBottleItem;
import com.qzimyion.bucketem.common.items.frogs.DryFrogBucketItem;
import com.qzimyion.bucketem.common.items.frogs.FrogBucketItem;
import com.qzimyion.bucketem.common.items.SlimeBottleItem;
...
public class ModItems {
    ...
    public static final RegistrySupplier<Item> ALLAY_POSSESSED_BOOK = ITEMS.register("allay_possessed_book",
            () -> new ContainedEntityItem(EntityType.ALLAY, Items.BOOK, SoundEvents.ENCHANTMENT_TABLE_USE, new Item.Properties().stacksTo(1)));
    public static final RegistrySupplier<Item> VEX_POSSESSED_BOOK = ITEMS.register("vex_possessed_book",
            () -> new ContainedEntityItem(EntityType.VEX, Items.BOOK, SoundEvents.ENCHANTMENT_TABLE_USE, new Item.Properties().stacksTo(1)));

    //==Bottles==//
    public static final RegistrySupplier<Item> BEE_BOTTLE = ITEMS.register("bee_bottle",
            () -> new ContainedEntityItem(EntityType.BEE, Items.GLASS_BOTTLE, SoundEvents.BOTTLE_FILL_DRAGONBREATH, new Item.Properties().stacksTo(1)));
    public static final RegistrySupplier<Item> SILVERFISH_BOTTLE = ITEMS.register("silverfish_bottle",
            () -> new ContainedEntityItem(EntityType.SILVERFISH, Items.GLASS_BOTTLE, SoundEvents.BOTTLE_FILL_DRAGONBREATH, new Item.Properties().stacksTo(1)));
    public static final RegistrySupplier<Item> ENDERMITE_BOTTLE = ITEMS.register("endermite_bottle",
            () -> new ContainedEntityItem(EntityType.ENDERMITE, Items.GLASS_BOTTLE, SoundEvents.BOTTLE_FILL_DRAGONBREATH, new Item.Properties().stacksTo(1)));
    public static final RegistrySupplier<Item> SLIME_BOTTLE = ITEMS.register("slime_bottle", () -> new SlimeBottleItem(new Item.Properties().stacksTo(1)));
    public static final RegistrySupplier<Item> MAGMA_CUBE_BOTTLE = ITEMS.register("magma_bottle", () ->
            new SlimeLikeBottleItem(EntityType.MAGMA_CUBE, Items.GLASS_BOTTLE, SoundEvents.BOTTLE_FILL_DRAGONBREATH, new Item.Properties().stacksTo(1)));
