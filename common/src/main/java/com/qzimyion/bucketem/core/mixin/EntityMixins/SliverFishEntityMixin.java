...
public abstract class SliverFishEntityMixin extends Monster implements Bucketable {
    ...
    @Unique
    private static final EntityDataAccessor<Boolean> FROM_BOTTLE = SynchedEntityData.defineId(SliverFishEntityMixin.class, EntityDataSerializers.BOOLEAN);

    protected SliverFishEntityMixin(EntityType<? extends Monster> entityType, Level world) {
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(ModItems.SILVERFISH_BOTTLE.get());
    }
