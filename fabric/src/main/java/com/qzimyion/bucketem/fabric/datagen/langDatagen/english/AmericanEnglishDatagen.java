...
public class AmericanEnglishDatagen extends FabricLanguageProvider {


    public AmericanEnglishDatagen(FabricDataOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
