...
import com.qzimyion.bucketem.core.registry.ModTags;
...
public class ModTagEntityDatagen extends FabricTagProvider.EntityTypeTagProvider {
    ...
    public void addTags(HolderLookup.Provider arg) {
        getOrCreateTagBuilder(ModTags.EntityTypeTagsForMod.MILKABLE_ENTITY).add(EntityType.COW).add(EntityType.GOAT);
    }
}
